...
if (isset($_POST['back'])) {
    ...
    if ($step == 2 && !isset($_POST['administration_time'])) {
        $record_message = "<p style='color: red;'>服用時間を選択してください。</p>";
    } else {
        $step++; // 次へ進むため、1だけ増やす
    }
        ...
        <?php elseif ($step == 2): ?>
            <div class="form-container">
                <form method="post" action="">
                    ...
                    <select name="administration_time" id="administration_time" required>
                        <option value="">選択してください</option>
